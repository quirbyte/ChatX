    ...
    return <div className="relative bg-zinc-900 h-115 w-100 rounded-2xl p-4 flex flex-col items-center">
        ...
        <form className="w-full mt-1.5 text-white flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col">
                ...
                <input
                    className="mt-2.5 bg-zinc-950/50 p-3 rounded-xl border-2 border-zinc-800 focus:outline-none focus:border-zinc-500 text-left tracking-wide text-sm"
                    type="text"
                    value={roomname}
                    disabled={loading}
            ...
            <button type="submit" disabled={loading} className="mt-4 bg-white text-black uppercase font-semibold w-full p-3 rounded-xl tracking-wider hover:opacity-90 disabled:opacity-50">Create</button>
