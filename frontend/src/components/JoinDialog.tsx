...
export default function JoinDialog({ handleClose }: { handleClose: () => void }) {
    ...
    return <div className="relative bg-zinc-950 border border-zinc-800 h-115 w-100 rounded-2xl p-4 flex flex-col items-center">
        ...
        <h1 className="text-white text-3xl text-center uppercase font-extrabold tracking-tighter">
            Join Room
        </h1>
        <form className="w-full mt-6 text-white flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading} className="mt-4 bg-white text-black font-semibold w-full p-3 rounded-xl tracking-normal hover:opacity-90 disabled:opacity-50">Join Room</button>
