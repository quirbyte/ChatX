...
export default function Navbar({joinDialog,createDialog}:NavbarProps) {
    ...
    return (
        <nav className="w-full h-16 border-b border-zinc-800 bg-zinc-950/50 backdrop-blur-md flex items-center justify-between px-10">
            <div className="flex items-center">
                <img
                    onClick={handleHome}
                    className="hover:opacity-80 h-10 w-10 cursor-pointer transition-opacity"
                    src="/icon.svg"
                    alt="ChatX Logo"
                />
            </div>
